...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260329170650_HardenPushSubscriptionsForBackgroundDeliverys")]
    partial class HardenPushSubscriptionsForBackgroundDeliverys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.AppointmentMessageLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("LastErrorRaw")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("AppointmentId", "Kind", "Channel", "CreatedDate");

                    b.ToTable("AppointmentMessageLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Models.AppointmentReviewRequestDispatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppointmentReviewRequestDispatches", (string)null);
                });

            modelBuilder.Entity("Core.Models.AutomationFailureLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AlertEmailSent")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("AlertEmailSentAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("AutomationFailureLogs", (string)null);
                });

            modelBuilder.Entity("Core.Models.BackgroundJobExecution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Models.BackgroundJobStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("NextPlannedRunAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Core.Models.ChecklistTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Models.ChecklistTemplateItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Models.Company", b =>
                {
                    ...
                    b.Property<string>("GuestyApiType")
                        .HasColumnType("text");

                    b.Property<string>("GuestyAuthBaseUrl")
                        .HasColumnType("text");

                    b.Property<string>("GuestyAuthScope")
                        .HasColumnType("text");

                    b.Property<string>("GuestyClientId")
                        .HasColumnType("text");

                    b.Property<string>("GuestyClientSecret")
                        .HasColumnType("text");

                    b.Property<DateTime?>("GuestyTokenExpiresAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("GuestyTokenType")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Models.CustomerAddress", b =>
                {
                    ...
                    b.Property<string>("GuestyListingId")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");

                    b.Property<string>("GuestyListingTitle")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("CustomerId", "GuestyListingId");
            ...
            modelBuilder.Entity("Core.Models.Payment", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "FinancialType", "DueDate");

                    b.ToTable("Payments", (string)null);
                });

            modelBuilder.Entity("Core.Models.PaymentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Models.PushSubscription", b =>
                {
                    ...
                    b.Property<bool>("IsPwaInstalled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<DateTime?>("LastPushAttemptAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastPushOpenedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastSeenAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastSuccessfulPushAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Core.Models.Checklist", b =>
                {
                    ...
                    b.HasOne("Core.Models.ChecklistTemplate", "ChecklistTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.ChecklistItem", b =>
                {
                    ...
                    b.HasOne("Core.Models.ChecklistTemplateItem", "ChecklistTemplateItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Payment", b =>
                {
                    ...
                    b.HasOne("Core.Models.PaymentCategory", "PaymentCategory")
                        .WithMany("Payments")

...
namespace Infrastructure.Repositories
{
    ...
    {
        Task<bool> ExistsActiveByNameAsync(int customerId, string name, int? excludeId = null);
    ...
    public class CustomerAreaRepository : GenericRepository<CustomerArea>, ICustomerAreaRepository
    {
        ...
        public IQueryable<CustomerArea> QueryByCustomer(int customerId, bool onlyActive) =>
            _dbContext.CustomerAreas
                      .AsNoTracking()
                      .Where(a => a.CustomerId == customerId && (!onlyActive || a.Active))
                      .OrderBy(a => a.Name);

        public async Task<bool> ExistsActiveByNameAsync(int customerId, string name, int? excludeId = null)
        {
